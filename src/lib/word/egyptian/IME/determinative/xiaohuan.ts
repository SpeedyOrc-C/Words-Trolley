/*
Xiaohuan (Threskiornis) is a way to type voiceless determinative using a scheme inspired
...
“小鹮”是用于输入埃及文中没有声音的定符的输入方案，灵感来自“小鹤音形”。
...
export const Xiaohuan: Record<string, string[]> = {
    "Q": ["𓂸", "𓄛", "𓃢", "𓃠"], // 且 犬 猫
    "W": ["𓀯"], // 王
